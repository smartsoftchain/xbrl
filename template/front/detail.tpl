...
<p>証券コード：<a href="http://stocks.finance.yahoo.co.jp/stocks/detail/?code={$code}.T" target="_blank">{$code}</a>　銘柄名：　{$name}</p>
